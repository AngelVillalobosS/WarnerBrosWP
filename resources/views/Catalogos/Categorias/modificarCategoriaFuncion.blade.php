...
<body data-path-to-root="../../" data-include-products="true" class="u-body u-xl-mode" data-lang="es">
    ...
    <section class="u-clearfix u-image u-section-1" id="sec-4f8f" data-image-width="626" data-image-height="391">
        <div class="u-clearfix u-sheet u-sheet-1">
            <a href="{{ route('modificarCategoria') }}" class="u-border-1 u-border-active-grey-40 u-border-black u-border-hover-black u-border-no-left u-border-no-right u-border-no-top u-btn u-button-style u-none u-text-body-color u-btn-1">Regresar </a>
                ...
                <div class="u-container-layout">
                    ...
                    <form action="{{ route('modificarCatFunc') }}" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 10px;">
                            ...
                            <div class="u-form-group">
                                ...
                                <input type="text" placeholder="ID de la Categoría" id="name-29e0" name="id_categoria" class="u-grey-80 u-input u-input-rectangle" value="{{ $id_categoria }}" readonly>
                            </div>
                            <div class="u-form-group">
