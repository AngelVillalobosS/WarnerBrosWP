...
<head>
    ...
    <link rel="stylesheet" href="consultar_clientes.css" media="screen">
    ...
    <meta property="og:title" content="consultar_clientes">
...
<body data-path-to-root="../../" data-include-products="true" class="u-body u-xl-mode" data-lang="es">
    <header class="u-black u-border-2 u-border-grey-75 u-clearfix u-header u-sticky u-sticky-4940 u-header"
        id="sec-6f4c">
                ...
                <div class="u-custom-menu u-nav-container">
                    <ul class="u-nav u-unstyled u-nav-1">
                        <li class="u-nav-item"><a
                                ...
                                href="../../index.html" style="padding: 10px 35px;">Inicio</a>
                        </li>
                        <li class="u-nav-item"><a
                                class="u-button-style u-nav-link u-text-active-grey-40 u-text-hover-grey-40"
                        ...
                        <li class="u-nav-item"><a
                            ...
                            <div class="u-nav-popup">
                                <ul class="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10">
                                    <li class="u-nav-item"><a
                                            class="u-active-grey-40 u-black u-button-style u-hover-grey-40 u-nav-link"
                                            href="../Categorias/categorias.html">Categorías</a>
                                    </li>
                                    <li class="u-nav-item"><a
                                            class="u-active-grey-40 u-black u-button-style u-hover-grey-40 u-nav-link"
                                    ...
                                    <li class="u-nav-item"><a
                                            class="u-active-grey-40 u-black u-button-style u-hover-grey-40 u-nav-link"
                                            href="../Productos/productos.html">Productos</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                            ...
                            <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-5">
                                    ...
                                    <div class="u-nav-popup">
                                        <ul class="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10">
                                            <li class="u-nav-item"><a class="u-button-style u-nav-link"
                                                    href="../../Registros/registrar_alquileres.html">Renta de
                                                    productos</a>
                                            </li>
                                            <li class="u-nav-item"><a class="u-button-style u-nav-link"
                                                    href="../../Registros/registrar_ventas.html">Ventas</a>
                                ...
                                <li class="u-nav-item"><a class="u-button-style u-nav-link">Reportes</a>
                                    <div class="u-nav-popup">
                                        <ul class="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10">
                                            <li class="u-nav-item"><a class="u-button-style u-nav-link"
                                                    href="../../Reportes/reporte_masVendidos.html">Contenido más
                                                    vendido</a>
                                            </li>
                                            <li class="u-nav-item"><a class="u-button-style u-nav-link"
                                                    href="../../Reportes/reporte_ventas.html">Ventas</a>
                                            ...
                                            <li class="u-nav-item"><a class="u-button-style u-nav-link"
                                                    href="../../Reportes/reporte_historial.html">Historial de
                                                    compras</a>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div class="u-form u-form-1">
                        <form action="https://forms.nicepagesrv.com/v2/form/process"
                            ...
                            <div class="u-align-center u-form-group u-form-submit">
                                <a href="#"
                                    class="u-black u-border-2 u-border-active-grey-40 u-border-grey-40 u-border-hover-grey-40 u-btn u-btn-submit u-button-style u-btn-2">Consultar<br>
                                </a>
    ...
    <footer class="u-align-center u-clearfix u-container-align-center u-footer u-grey-90 u-footer" id="sec-9b91">
        <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
            <p class="u-small-text u-text u-text-variant u-text-1"> © 2024 Tienda de Cinematografías. Todos los derechos
                reservados.</p>
        </div>
    </footer>
