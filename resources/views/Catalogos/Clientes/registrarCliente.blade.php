                    ...
                    <div class="u-form u-form-1">
                        ...
                        <form action="{{ route('saveCliente')}}"
                            ...
                            <div class="u-form-group u-form-partition-factor-2">
                                ...
                                <input type="text" id="name-29e0" name="id_cliente"
                                    class="u-grey-75 u-input u-input-rectangle" required="required" readonly=''>
                            </div>
                            <div class="u-form-group u-form-partition-factor-2">
                                <label for="email-29e0" class="u-label u-text-black u-label-2">Nombre</label>
                                <input type="text" placeholder="Introduzca el nombre" id="email-29e0"
                            ...
                            <div class="u-form-group u-form-partition-factor-2 u-form-group-3">
                                ...
                                <input type="text" placeholder="Introduzca el apellido paterno" id="text-93a1"
                                    name="ap_cliente" class="u-grey-75 u-input u-input-rectangle">
                            </div>
                            <div class="u-form-group u-form-partition-factor-2 u-form-group-4">
                                ...
                                <input type="text" placeholder="Introduzca el apellido materno" id="text-cfa5"
                                    name="am_cliente" class="u-grey-75 u-input u-input-rectangle">
                            </div>
                            <div class="u-form-group u-form-partition-factor-2 u-form-phone u-form-group-5">
                                ...
                                <input type="tel" placeholder="222 123 4567" id="text-7f3e" name="telefono"
                            ...
                            <div class="u-form-email u-form-group u-form-partition-factor-2 u-form-group-6">
                                <label for="text-31be" class="u-label u-text-black u-label-6">Correo Electrónico
                                </label>
                                <input type="email" id="text-31be" name="correo"
                                    class="u-grey-75 u-input u-input-rectangle" placeholder="correo@gmail.com">
                            </div>
                            <div class="u-align-center u-form-group u-form-submit">
                                <a href="#"
                                    class="u-black u-border-2 u-border-active-grey-40 u-border-grey-40 u-border-hover-grey-40 u-btn u-btn-submit u-button-style u-btn-2">Registrar
                                </a>
