...
<head>
    ...
    <link rel="stylesheet" href="reporte_masVendidos.css" media="screen">
    ...
    <meta property="og:title" content="reporte_masVendidos">
...
<body data-path-to-root="../" data-include-products="true" class="u-body u-xl-mode" data-lang="es">
    ...
    <section class="u-clearfix u-image u-section-1" id="sec-e752" data-image-width="626" data-image-height="391">
                    ...
                    <div class="u-form u-form-1">
                        <form action="https://forms.nicepagesrv.com/v2/form/process"
                            ...
                            <div class="u-form-date u-form-group u-form-group-1">
                                ...
                                <input type="text" placeholder="MM/DD/AAAA" id="date-65bb" name="fecha_venta-1"
                            ...
                            <div class="u-form-date u-form-group u-form-group-2">
                                ...
                                <input type="text" placeholder="MM/DD/AAAA" id="date-2c38" name="fecha_venta"
